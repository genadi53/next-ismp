...
import { UsersRound, X, Search } from "lucide-react";
...
export function DataTableOperators<TData, TValue>({
  columns,
  data,
            ...
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                <TableCell colSpan={columns.length}>
                  <NoResults
                    title="Няма намерени оператори"
                    description="Опитайте да промените филтрите или да добавите нов оператор"
                    icon={
                      <UsersRound className="text-ell-primary/50 size-12" />
                    }
                  />
                </TableCell>
              </TableRow>
